...
export const metadata = {
    title: "Laboratoire - La liste de tâches avec HTTPS",
    description: "Présentation du laboratoire de la liste de tâches où l'on mettra en place le protocole HTTPS en développement local.",
    keywords: ["liste", "tâches", "https", "ssl", "sécurité"],
    group: "labs"
}
...
export default function Page() {
    return <>
        <section>
            ...
            <p>
                Ce laboratoire est une extension du laboratoire de la <a href="/module-8/lab-todo/">liste de tâches avec authentification</a>. 
        ...
        <section>
            ...
            <DownloadBlock>
                <File fileName="distribué.zip" path="/labs/https-todo-distribué.zip">distribué.zip</File>
                <File fileName="solution.zip" path="/labs/https-todo-solution.zip">solution.zip</File>
            </DownloadBlock>
        </section>
    </>
}
