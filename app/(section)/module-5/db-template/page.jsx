...
export const metadata = {
    title: "Gabarit avec base de données",
    description: "Présentation du gabarit avec base de données SQLite pour la création de serveurs web avec Node.js et Express.js.",
    keywords: ["templates", "gabarit", "node.js", "express", "middlewares", "dotenv", "sqlite"],
    group: "templates"
}
    ...
    return <>
        <section>
            ...
            <p>
                ...
                et Express.js. Ce gabarit est conçu à partir du <Link href="/module-2/basic-template/">gabarit de base</Link>, mais
                auquel nous lui avons ajouté une base de données SQLite. Voici comment l'utiliser:
            </p>
            <ol>
        ...
        <section>
            ...
            <DownloadBlock>
                <File fileName="gabarit-bd.zip" path="/templates/db.zip">gabarit-bd.zip</File>
            </DownloadBlock>
        </section>
    </>
}